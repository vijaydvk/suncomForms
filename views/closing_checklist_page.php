...
<html>
  <head>
	...
	<script src="js/closing_checklist.js"></script>
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="card">
                     <div class="card-header d-flex align-items-center">
                      <h5 class="h5">Closing Checklist Report</h5>
                    </div>
                    <div class="card-body">
                      <!--<p>Lorem ipsum dolor sit amet consectetur.</p>-->
						...
						<div id="disp_closing_checklist_answer">
						</div>
                   </div>                  
                </div>
				<div class="modal" id="pleaseWaitDialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="margin-top:100px;display:none;">
